...
<html lang="en">
  <head>
    <title>Treatments - Glowneck</title>
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row block-9">
                <div class="col-md-4 contact-info ftco-animate">
                    ...
                    <h2 style="font-weight=bold" align="center">Rp 250.000</h2>
                    <hr />
                </div>
                <div class="col-md-1"></div>
      <div class="col-md-6 ftco-animate">
        <h2 class="mb-4">Glow Neck Peel</h2>
    	<p>Glow Neck Peel yaitu untuk membantu mencerahkan, melembabkan serta membantu mengencangkan dan menyamarkan kerutan halus pada kulit leher.
        </p>
