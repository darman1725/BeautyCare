  ...
  <body>
    ...
    <section class="ftco-section">
      ...
      <div class="col-md-6 ftco-animate">
        <h2 class="mb-4">Acne Cure for Back</h2>
    	<p>Acne Diode Laser adalah treatment atau perawatan yang disediakan oleh klinik kecantikan sebagai
            salah satu cara menghilangkan jerawat membandel. Sesuai namanya, treatment ini menggunakan laser dalam
            metode pengobatannya dengan teknologi energi Diode,yang dapat menembus kulit hingga lapisan folikel kelenjar sebaceous.</p>
        <p>Terapi Laser Diode 1450nm yang sangat efektif untuk mengurangi ukuran kelenjar minyak pada punggung,
            sehingga mencegah kambuhnya jerawat.
        </p>
        </p>
