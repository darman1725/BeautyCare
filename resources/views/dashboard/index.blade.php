    ...
    <div class="row">
        <div class="col-md-6 col-xl-4 mb-3 mb-xl-4">
            ...
            <div class="card flex-row align-items-center p-3 p-md-4">
                ...
                <div>
                    <h4 class="lh-1 mb-1">{{ $treatments }}</h4>
                    <h6 class="mb-0">Layanan Treatments</h6>
                </div>
            </div>
            <!-- End Widget -->
        </div>
                            ...
                            <tbody>
                                @foreach ($transactions as $item)
                                    <tr>
                                        ...
                                        <td class="py-3">Rp {{ number_format($item->treatments->harga, 0, ',', '.') }}</td>
                                        <td class="py-3">
