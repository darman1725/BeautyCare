    	...
    	<div class="container">
    		<div class="row block-9">
                <div class="col-md-4 contact-info ftco-animate">
                    <div class="row">
                        <img class="card-img-top" src="assets/images/dokter2.png" alt="Card image" style="width:100%">
                    </div>
                    <br>
                </div>
                <div class="col-md-1"></div>
      <div class="col-md-6 ftco-animate">
        <h2 class="mb-4">dr. Agustina Tripujiastuti, Sp.KK</h2>
    	...
    	<p>
            ...
            <li>Rabu   : 10.00 - 12.00</li>
            <li>Kamis  : 08.00 - 12.00</li>
            <li>Jumat  : 09.00 - 12.00</li>
        </p>
        <br><br>
