    	...
    	<div class="container">
    		<div class="row block-9">
                <div class="col-md-4 contact-info ftco-animate">
                    <div class="row">
                        <img class="card-img-top" src="assets/images/dokter2.1.png" alt="Card image" style="width:100%">
                    </div>
                    <br>
                </div>
                <div class="col-md-1"></div>
      <div class="col-md-6 ftco-animate">
        <h2 class="mb-4">dr. Ainun Rojannah Ayatullah</h2>
        <div id="rectangle" align="center">Dokter Umum</div>
        <br><br>
        <b><h5>Jadwal Tersedia:</h5><b>
    	<p>
            <li>Senin  : 08.00 - 11.00</li>
            <li>Selasa : 08.00 - 11.00</li>
            <li>Rabu   : 10.00 - 15.00</li>
            <li>Kamis  : 13.00 - 15.00</li>
            <li>Jumat  : 09.00 - 15.00</li>
        </p>
        <br><br>
