...
@media screen and (max-width: 768px) {
   ...
   <link rel="shortcut icon" href="assets/images/icon.png">
	    ...
	    <div class="container">
	      <a class="navbar-brand" href="{{ url('layouts.index') }}"><img src ="assets/images/relax.png" width="30px">&nbsp;BeautyCare</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{ url('layouts.treatments') }}" class="nav-link">Treatments</a></li>
	          <li class="nav-item active"><a href="{{ url('layouts.specialists') }}" class="nav-link">Doctor</a></li>
