                    ...
                    <div class="row justify-content-center my-auto">
                        <div class="col-md-8 col-10 my-5">
                            <div class="row justify-content-center px-3 mb-3"> <img id="logo"
                                    src="assets/images/icon.png"> </div>
                            ...
                            <div class="form-group"> <label class="form-control-label text-muted">Username</label>
                                <input type="text" id="email" name="email" placeholder="Masukkan Username"
                                    class="form-control"> </div>
                            <div class="form-group"> <label class="form-control-label text-muted">Password</label>
                                <input type="password" id="psw" name="psw" placeholder="Masukkan Password"
                                    class="form-control"> </div>
                            <div class="row justify-content-center my-3 px-3"> <a href="{{ route('layouts.index') }} "
                                    class="btn btn-white ml-2">Masuk ke BeautyCare</a> </div>
                            <div class="row justify-content-center my-2"> <a href="{{route("password.reset")}}"><small
