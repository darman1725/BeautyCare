  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{ route('layouts.login') }}" class="nav-link">Login</a></li>
      ...
      <div class="container">
		...
		<section class="ftco-section ftco-intro" style="background-image: url(assets/images/homehijab.jpg);">
			<div class="container" width="50%">
	          ...
	          <p class="mb-4 ftco-animate">Ada banyak manfaat melakukan facial di klinik kecantikan, salah satunya adalah untuk membersihkan pori-pori kulit secara menyeluruh. Selain itu, masalah kulit yang Anda hadapi juga bisa ditangani oleh profesional yang bisa melakukan treatment yang sesuai dan bermanfaat. Facial treatment juga membantu kulit bisa tampak lebih muda dan segar kembali.</p>
	          <ul class="mt-5 do-list">
	          	<p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Untuk engatasi pori-pori kulit yang besar, menyamarkan tanda penuaan, hingga mencerahkan kulit</a></p>
