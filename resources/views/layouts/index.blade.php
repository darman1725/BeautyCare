...
<body>
  ...
  <section class="hero-wrap js-fullheight" style="background-image: url('assets/images/bg_1.jpg');"
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        <div class="col-md-10 ftco-animate text-center">
          <div class="icon">
            <img src="assets/images/relax.png" width="100px">
            <br>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-md-7 mb-3">
              <p>Selamat datang di website Klinik BeautyCare, kami adalah klinik perawatan kulit wajah dan badan
                ...
                jenis dan masalah kulit yang berbeda-beda, untuk itu kami menyediakan berbagai macam perawatan
                kecantikan
  ...
  <section class="ftco-section ftco-intro" style="background-image: url(assets/images/homehijab.jpg);">
    <div class="container" width="50%">
      <div class="row justify-content-end">
        <div class="col-md-6">
          <div class="heading-section ftco-animate">
            <h2 class="mb-4">Manfaat melakukan Treatments</h2>
          </div>
          <p class="mb-4 ftco-animate">Ada banyak manfaat melakukan facial di klinik kecantikan, salah satunya adalah
            untuk membersihkan pori-pori kulit secara menyeluruh. Selain itu, masalah kulit yang Anda hadapi juga bisa
            ditangani oleh profesional yang bisa melakukan treatment yang sesuai dan bermanfaat. Facial treatment juga
            membantu kulit bisa tampak lebih muda dan segar kembali.</p>
          <ul class="mt-5 do-list">
            <p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Untuk engatasi pori-pori kulit
              yang besar, menyamarkan tanda penuaan, hingga mencerahkan kulit</a></p>
            <p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Untuk mengembalikan kecerahan dan
              “kemurnian” kulit secara optimal</a></p>
            <p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Membantu Mengencangkan Kulit Yang
              Kendur</a></p>
            <p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Membantu Proses Regenerasi
              Kulit</a></p>
            <p class="ftco-animate"><span class="ion-ios-checkmark-circle mr-3"></span>Mengurangi Noda Bekas Jerawat</a>
            </p>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 ftco-animate">
          <a href="assets/images/1.png" class="gallery image-popup img d-flex align-items-center"
        ...
        <div class="col-md-3 ftco-animate">
          <a href="assets/images/3.jpg" class="gallery image-popup img d-flex align-items-center"
        ...
        <div class="col-md-3 ftco-animate">
          <a href="assets/images/5.png" class="gallery image-popup img d-flex align-items-center"
            style="background-image: url(assets/images/5.png);">
            <div class="d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-3 ftco-animate">
          <a href="assets/images/6.jpg" class="gallery image-popup img d-flex align-items-center"
