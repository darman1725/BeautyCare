...
<head>
    ...
    <!-- Favicon -->
    <a><link rel="shortcut icon" href="{{ asset('img/relax.png') }}">BeautyCare</a>
        ...
        <nav class="navbar flex-nowrap p-0">
            <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
                ...
                <a class="navbar-brand navbar-brand-mobile" href="/">
                    <img class="img-fluid w-100" src="{{ asset('img/relax.png') }}" alt="Graindashboard">
                </a>
                <!-- End Logo For Mobile View -->

                <!-- Logo For Desktop View -->
                <a class="navbar-brand navbar-brand-desktop" href="/">
                    <img class="side-nav-show-on-closed" src="{{ asset('img/relax.png') }}" alt="Graindashboard" style="width: auto; height: 33px;">
                </a>
    ...
    @section('sidebar')
        <aside id="sidebar" class="js-custom-scroll side-nav">
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                ...
                <!-- Data Customer -->
                <li class="side-nav-menu-item">
                    <a class="side-nav-menu-link media align-items-center" href="{{ route('customers.index') }}">
                <span class="side-nav-menu-icon d-flex mr-3">
                    <i class="gd-tag"></i>
                </span>
                        <span class="side-nav-fadeout-on-closed media-body">Customer</span>
                    </a>
                </li>
                <!-- End Data Customer -->

                <!-- Data Layanan Treatments -->
                <li class="side-nav-menu-item">
                    <a class="side-nav-menu-link media align-items-center" href="{{ route('treatments.index') }}">
                <span class="side-nav-menu-icon d-flex mr-3">
                    <i class="gd-car"></i>
                </span>
                        <span class="side-nav-fadeout-on-closed media-body">Treatments</span>
                    </a>
                </li>
                <!-- End Layanan Treatments -->

                <!-- Data KonsultasI Doctor -->
                <li class="side-nav-menu-item">
                    <a class="side-nav-menu-link media align-items-center" href="{{ route('doctors.index') }}">
                <span class="side-nav-menu-icon d-flex mr-3">
                    <i class="gd-car"></i>
                </span>
                        <span class="side-nav-fadeout-on-closed media-body">Dokter</span>
                    </a>
                </li>
                <!-- End Data KonsultasI Doctor -->
                ...
                <li class="side-nav-menu-item side-nav-has-menu">
                    ...
                    <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('transactions.order') }}">Data Reservasi</a>
                        </li>
                        <li class="side-nav-menu-item">
