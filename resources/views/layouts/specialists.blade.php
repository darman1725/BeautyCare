        ...
        <div class="col-lg-3 d-flex">
          <div class="coach align-items-stretch">
            ...
            <div class="text bg-white p-4 ftco-animate">
              ...
              <p>dr. Agustina Tripujiastuti, Sp.KK adalah seorang Dokter Spesialis Kulit dan Kelamin yang aktif melayani
                pasien
                di Klinik BeautyCare dr. Agustina Tripujiastuti mendapatkan gelar spesialisnya setelah menamatkan
                pendidikan
        ...
        <div class="col-lg-3 d-flex">
          <div class="coach align-items-stretch">
            ...
            <div class="text bg-white p-4 ftco-animate">
              ...
              <p>dr. Ainun Rojannah Ayatullah adalah seorang Dokter Umum yang aktif melayani pasien di Klinik
                BeautyCare. dr. Ainun Rojannah Ayatullah mendapatkan gelar
