...
<html lang="en">
  <head>
    <title>BeautyCare - Halaman Blog-Single</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('index') }}">Home</a></span> <span class="mr-2"><a href="{{ url('blog') }}">Blog</a></span> <span>Blog Single</span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Jl. Sukarno Hatta No 32, Malang</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">081375685166</span></a></li>
