...
<head>
    ...
    <title>BeautyCare - Halaman Lupa password </title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ route('layouts.index') }}">
                <img src="{{asset("assets/images/relax.png")}}" width="30px">&nbsp;BeautyCare</a>
                        ...
                        <div class="col-md-8 col-10 my-5">
                            <div class="row justify-content-center px-3 mb-3">
                                <div class="d-flex flex-column align-items-center">
                                    <img id="logo" src="{{asset("assets/images/icon.png")}}">
                                    <h3 class="mb-5 text-center">BeautyCare</h3>
                                </div>
                                <h6 class="msg-info">Lupa password account anda.</h6>
                            </div>
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group row">
                                    <label for="email"
                                        class="form-control-label text-muted">{{ __('E-Mail Address') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password"
                                        class="form-control-label text-muted">{{ __('Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm"
                                        class="form-control-label text-muted">{{ __('Confirm Password') }}</label>
